class Usuario < ActiveRecord::Base
  ...
  has_many :proyecto_usuarios, :class_name => "Proyectousuario", :dependent => :destroy
  has_many :proyectos_unidos, :through => :proyecto_usuarios, :source => :proyecto
  ...
  lifecycle do
    ...
    create :invite,
           ...
           :new_key => true,
           :become => :invited do
       UsuarioMailer.invite(self, lifecycle.key).deliver
    end
    ...
    transition :request_password_reset, { :active => :active }, :new_key => true do
      UsuarioMailer.forgot_password(self, lifecycle.key).deliver
    end
